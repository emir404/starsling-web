...
export function InputScene() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        variants={row}
        className="absolute left-[-1.88px] top-[-1.87px] h-[90px] w-[881.25px] overflow-clip border-b border-black/5 bg-white/90 dark:bg-[rgba(56,67,67,0.9)]"
      >
      ...
      <motion.div
        variants={row}
        className="absolute left-[calc(50%-1.34px)] top-[109.86px] h-[90px] w-[836.25px] -translate-x-1/2 overflow-clip border border-black/5 bg-white/90 dark:bg-[rgba(56,67,67,0.9)]"
      >
      ...
      <motion.div
        variants={row}
        className="absolute left-[20.63px] top-[223.12px] h-[90px] w-[836.25px] overflow-clip border border-black/5 bg-white/90 dark:bg-[rgba(56,67,67,0.9)]"
      >
